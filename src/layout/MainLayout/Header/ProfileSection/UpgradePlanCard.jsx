...
export default function UpgradePlanCard() {
  ...
  const cardSX = {
    ...
    width: 200,
    height: 200,
    borderColor: isDark ? '#D97706' : 'warning.main'
  };

  return (
    <Card
      sx={{
        bgcolor: isDark ? '#334155' : 'warning.light',
        my: 2,
        overflow: 'hidden',
        position: 'relative',
        '&:after': {
    ...
    >
      <CardContent>
        <Stack sx={{ gap: 2 }}>
          <Typography variant="h4" sx={{ color: isDark ? '#F1F5F9' : undefined }}>Upgrade your plan</Typography>
          <Typography
            variant="subtitle2"
            sx={{
              color: isDark ? '#94A3B8' : 'grey.900',
              opacity: 0.6
            }}
          >
