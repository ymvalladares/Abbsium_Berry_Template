    ...
    <>
      <Chip
        ...
        sx={{
          ...
          '&:hover': { bgcolor: isDark ? '#334155' : undefined }
        }}
        icon={
          <Avatar
            src={User1}
        ...
        {({ TransitionProps }) => (
          <ClickAwayListener onClickAway={handleClose}>
            <Transitions in={open} {...TransitionProps}>
              <Paper sx={{ bgcolor: isDark ? '#111827' : undefined }}>
                <MainCard border={false} elevation={16} content={false} boxShadow shadow={theme.shadows[16]}>
                  <Box sx={{ p: 2, pb: 0 }}>
                    ...
                    <OutlinedInput
                      sx={{
                        ...
                        bgcolor: isDark ? '#1e293b' : undefined,
                        '& fieldset': { borderColor: isDark ? '#475569' : undefined },
                  ...
                  <Box sx={{ p: 2, maxHeight: 'calc(100vh - 250px)', overflowX: 'hidden' }}>
                    ...
                    <Card sx={{ bgcolor: isDark ? '#334155' : 'primary.light', my: 2 }}>
                      <CardContent>
                        <Stack gap={3}>
                    ...
                    <List sx={{ minWidth: 300 }}>
                      <ListItemButton onClick={settingsOptions} sx={{ borderRadius, '&:hover': { bgcolor: isDark ? '#1e293b' : undefined } }}>
                        <ListItemIcon>
                      ...
                      <ListItemButton onClick={handleLogout} sx={{ borderRadius, '&:hover': { bgcolor: isDark ? '#1e293b' : undefined } }}>
                        <ListItemIcon>
                          <IconLogout size={20} />
                        </ListItemIcon>
