...
export default function Customization() {
  ...
  return (
    <>
      ...
      <Drawer anchor="right" onClose={handleToggle} open={open} slotProps={{ paper: { sx: { width: 375, bgcolor: isDark ? '#0f172a' : undefined } } }}>
        {open && (
          <SimpleBar>
            <MainCard content={false} border={false}>
              <Stack direction="row" sx={{ alignItems: 'center', justifyContent: 'space-between', p: 2.5, gap: 1.5 }}>
                ...
                <Stack direction="row" sx={{ alignItems: 'center', gap: 1.25 }}>
                  ...
                  <IconButton sx={{ p: 0, color: isDark ? '#94a3b8' : 'grey.600' }} onClick={handleToggle}>
