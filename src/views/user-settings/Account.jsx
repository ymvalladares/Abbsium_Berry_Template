  ...
  return (
    <Box sx={{ maxWidth: '100%' }}>
      ...
      >
        ...
        <Divider sx={{ mx: { xs: 3, sm: 4, md: 5 }, borderColor: isDark ? '#374151' : undefined }} />
        ...
        <Box sx={{ px: { xs: 3, sm: 4, md: 5 }, py: { xs: 3, sm: 4 } }}>
          ...
          <Divider sx={{ mb: 4, borderColor: isDark ? '#374151' : '#f1f5f9' }} />
          ...
          >
            ...
            <Box sx={{ flex: 1, width: { sm: '68%' } }}>
              <TextField
                ...
                InputProps={{
                  startAdornment: <AlternateEmail sx={{ color: isDark ? '#64748b' : '#94a3b8', fontSize: 20, mr: 1 }} />
                }}
                sx={{
                  ...fieldStyle,
                  '& .MuiOutlinedInput-root': {
          ...
          >
            ...
            <Box sx={{ flex: 1, width: { sm: '68%' } }}>
              <TextField
                ...
                disabled
                InputProps={{
                  startAdornment: <Mail sx={{ color: isDark ? '#64748b' : '#94a3b8', fontSize: 20, mr: 1 }} />,
                  endAdornment: (
              ...
              <Box
                sx={{
                  ...
                  px: { xs: 2.5, sm: 3 },
                  py: { xs: 2, sm: 2.5 },
                  background: isDark ? `linear-gradient(135deg, #0c4a6e 0%, #1e293b 100%)` : `linear-gradient(135deg, ${primaryUltraLight} 0%, #ffffff 100%)`,
                  borderRadius: 3,
