...
export const HorizontalStepper = ({ sections, activeSection, onSectionChange }) => {
            ...
            >
              ...
              <Box
                sx={{
                  ...
                  boxShadow: isActive ? (isDark ? '0 4px 12px rgba(0,0,0,0.3)' : '0 4px 12px rgba(15, 23, 42, 0.12)') : 'none',
                }}
              >
                {isCompleted ? (
