...
const auroraBlobs = (isDark) => [
  { color: `rgba(59,130,246,${isDark ? 0.34 : 0.22})`, size: 440, top: '-140px', left: '14%' },
  { color: `rgba(20,184,166,${isDark ? 0.24 : 0.15})`, size: 400, top: '18%', left: '48%' },
  { color: `rgba(59,130,246,${isDark ? 0.2 : 0.12})`, size: 360, top: '44%', left: '28%' }
];
