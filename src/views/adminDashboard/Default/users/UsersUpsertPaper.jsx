    ...
    <Fade in={open}>
      ...
      >
        ...
        >
          ...
          <Box sx={{ p: 3, borderBottom: isDark ? '1px solid #374151' : '1px solid #f1f5f9', display: 'flex', justifyContent: 'space-between' }}>
            <Box>
              <Typography variant="h6" sx={{ fontWeight: 800, color: isDark ? '#f1f5f9' : '#0f172a', lineHeight: 1.1 }}>
            ...
            <IconButton onClick={onClose} size="small" sx={{ height: 32, width: 32, border: isDark ? '1px solid #374151' : '1px solid #f1f5f9' }}>
            ...
            <Stack spacing={3}>
              ...
              <Box>
                <Stack direction="row" spacing={1} alignItems="center" sx={{ mb: 2 }}>
                  ...
                  <Typography
                    variant="subtitle2"
                    sx={{ fontWeight: 700, fontSize: '0.8rem', color: isDark ? '#f1f5f9' : '#0f172a', textTransform: 'uppercase' }}
                  >
                    Identity Details
                  </Typography>
                </Stack>
                <Stack spacing={2}>
                  ...
                  <TextField
                    ...
                    sx={mode === 'edit' ? { ...(isDark ? darkInputStyle : inputStyle), '& .MuiOutlinedInput-root': { bgcolor: isDark ? '#0f172a' : '#f8fafc' } } : (isDark ? darkInputStyle : inputStyle)}
                    size="small"
              ...
              <Box>
                ...
                <Typography variant="caption" sx={{ color: isDark ? '#94a3b8' : '#64748b', mb: 2, display: 'block' }}>
                    ...
                    return (
                      <Box
                        ...
                        sx={{
                          ...
                          borderRadius: '12px',
                          border: '1.5px solid',
                          borderColor: isSelected ? '#6366f1' : isDark ? '#374151' : '#f1f5f9',
                          bgcolor: isSelected ? alpha('#6366f1', 0.02) : isDark ? '#0f172a' : '#fff',
                          cursor: mode === 'create' ? 'pointer' : 'default',
                          transition: '0.2s',
                          position: 'relative',
                          '&:hover': mode === 'create' ? { borderColor: isSelected ? '#6366f1' : isDark ? '#4B5563' : '#cbd5e1' } : {}
                        }}
                      >
                        <Typography sx={{ fontWeight: 700, fontSize: '0.85rem', color: isSelected ? '#6366f1' : isDark ? '#f1f5f9' : '#0f172a' }}>
                          {r.label}
                        </Typography>
                        <Typography variant="caption" sx={{ color: isDark ? '#94a3b8' : '#64748b', display: 'block', lineHeight: 1.2 }}>
                          {r.desc}
                        </Typography>
                        {isSelected && (
                          <Box
              ...
              <Stack spacing={1} sx={{ pt: 1 }}>
                ...
                <Button onClick={onClose} fullWidth sx={{ color: isDark ? '#94a3b8' : '#64748b', textTransform: 'none', fontWeight: 600, fontSize: '0.85rem' }}>
                  Discard and exit
                </Button>
              </Stack>
            </Stack>
