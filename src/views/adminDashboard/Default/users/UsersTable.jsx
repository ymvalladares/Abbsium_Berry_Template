          ...
          <Table>
            <TableHead>
              <TableRow>
                ...
                <TableCell sx={{ color: isDark ? '#ffffff' : undefined, fontWeight: 600, borderBottom: isDark ? '2px solid #374151' : undefined }}>User</TableCell>
                {!isMobile && <TableCell sx={{ color: isDark ? '#ffffff' : undefined, fontWeight: 600, borderBottom: isDark ? '2px solid #374151' : undefined }}>Email</TableCell>}
                {!isTablet && <TableCell sx={{ color: isDark ? '#ffffff' : undefined, fontWeight: 600, borderBottom: isDark ? '2px solid #374151' : undefined }}>Role</TableCell>}
                <TableCell sx={{ color: isDark ? '#ffffff' : undefined, fontWeight: 600, borderBottom: isDark ? '2px solid #374151' : undefined }}>Email Confirmed</TableCell>
                ...
                <TableRow key={user.id} hover>
                  ...
                  <TableCell>
                    <Chip
                      ...
                      sx={isDark ? {
                        bgcolor: user.emailConfirmed ? 'rgba(34,197,94,0.1)' : 'rgba(234,179,8,0.1)',
                        borderColor: user.emailConfirmed ? '#22c55e' : '#eab308',
                        color: user.emailConfirmed ? '#4ade80' : '#facc15',
                        fontWeight: 600,
                      } : undefined}
                    />
                  </TableCell>
