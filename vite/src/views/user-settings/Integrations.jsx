      ...
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, flex: 1, minWidth: 0 }}>
        <Box
          sx={{
            ...
            height: 44,
            borderRadius: 2.5,
            bgcolor: item.connected ? `${primaryColor}10` : '#f8fafc',
            border: item.connected ? `1.5px solid ${primaryColor}30` : '1.5px solid #e2e8f0',
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'center',
            color: item.connected ? primaryColor : '#94a3b8',
            flexShrink: 0,
        ...
        <Box sx={{ minWidth: 0 }}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
            <Typography
              variant="body2"
              fontWeight={600}
              sx={{ color: '#1e293b', fontSize: '0.9rem' }}
            >
              {item.name}
            </Typography>
            {item.popular && (
        ...
        <Box sx={{ px: { xs: 3, sm: 4, md: 5 }, py: { xs: 1, sm: 1.5 } }}>
          {connected.length > 0 ? (
            ...
            <Box sx={{ py: 4, textAlign: 'center' }}>
              <Extension sx={{ fontSize: 40, color: '#cbd5e1', mb: 1.5 }} />
