...
import { Box, Typography, Avatar, Chip, Paper, IconButton, ThemeProvider, Stack, Divider } from '@mui/material';
    ...
    <ThemeProvider theme={stepperTheme}>
      <Box>
        <Box sx={{ mx: 'auto', px: { xs: 2, sm: 3, md: 4 }, py: { xs: 2.5, sm: 3.5 } }}>
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <Avatar src={avatarPreview} sx={{ width: 46, height: 46, border: '1px solid #e2e8f0' }} />
                  <Box
              ...
              <Stack direction="row" spacing={3} alignItems="center" justifyContent="center" sx={{ width: { xs: '100%', sm: 'auto' } }}>
                ...
                <Divider orientation="vertical" flexItem sx={{ borderColor: '#f1f5f9', height: 20, my: 'auto' }} />
                ...
                <Divider
                  ...
                  flexItem
                  sx={{ borderColor: '#f1f5f9', height: 20, my: 'auto', display: { xs: 'none', sm: 'block' } }}
                />
          ...
          <Paper sx={{ mb: 3, px: { xs: 2, sm: 3, md: 5 }, borderRadius: 3, border: '1px solid #e2e8f0' }}>
