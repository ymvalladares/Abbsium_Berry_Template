          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
            ...
            <Box>
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                <Typography sx={{ fontWeight: 700, color: '#475569', fontSize: '1rem', lineHeight: 1.2 }}>
              ...
              <Typography variant="caption" sx={{ color: '#64748b', fontSize: '0.7rem', letterSpacing: '0.02em' }}>
      ...
      >
        {isLoading ? (
          ...
          <Box sx={{ textAlign: 'center', py: 8, px: 3 }}>
            ...
            <Typography variant="body2" sx={{ color: '#475569', fontWeight: 500, mb: 0.5 }}>
