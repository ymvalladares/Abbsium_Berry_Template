                ...
                icon={
                  <Box
                    sx={{
                      ...
                      alignItems: 'center',
                      justifyContent: 'center',
                      bgcolor: i === step ? ACCENT : i < step ? '#4CAF50' : '#e0e0e0',
                  ...
                  InputProps={{
                    startAdornment: (
                      <InputAdornment position="start">
                        <IconLink size={15} color={videoId ? '#4CAF50' : '#999'} />
                      </InputAdornment>
                    ),
                    endAdornment: url && (
            ...
            {step === 4 && (
              <Box>
                  ...
                  <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2} alignItems={{ xs: 'flex-start', sm: 'center' }}>
                    ...
                    <Box sx={{ flex: 1, minWidth: 0 }}>
                      ...
                      <Stack direction="row" spacing={0.75} flexWrap="wrap" useFlexGap>
                        {[
                          { label: `${clips?.value} clips`, color: ACCENT, light: '#fff' },
                          { label: format, color: '#1e293b', light: '#f1f5f9' },
                          { label: duration?.label, color: '#1e293b', light: '#f1f5f9' }
                        ].map((tag, i) => (
                          <Chip
                            key={i}
                            label={tag.label}
                ...
                <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', sm: 'repeat(3, 1fr)' }, gap: { xs: 1.5, sm: 2 } }}>
                  {/* Platforms */}
                  <Box sx={{ p: { xs: 1.25, sm: 1.5 }, borderRadius: 2, border: '1px solid', borderColor: 'divider', bgcolor: 'grey.50' }}>
